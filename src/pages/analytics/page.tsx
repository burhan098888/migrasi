...
import ComprehensiveKPISection from "./_components/comprehensive-kpi-section.tsx";
...
export default function AnalyticsPage() {
  ...
  const comprehensiveKPI = useQuery(api.analytics.getComprehensiveKPI, periodArgs);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      {/* Tabs */}
      <Tabs defaultValue="team-kpi">
        <TabsList className="mb-4">
          <TabsTrigger value="team-kpi">Team KPI</TabsTrigger>
          <TabsTrigger value="task-analytics">Task Analytics</TabsTrigger>
          <TabsTrigger value="user-details">User Details</TabsTrigger>
        </TabsList>

        {/* ────── TAB: Team KPI ────── */}
        <TabsContent value="team-kpi" className="mt-0">
          {comprehensiveKPI ? (
            <ComprehensiveKPISection
              users={comprehensiveKPI.users}
              summary={comprehensiveKPI.summary}
            />
          ) : (
        ...
        {/* ────── TAB: Task Analytics ────── */}
        <TabsContent value="task-analytics" className="mt-0 space-y-6">
          {/* KPI Cards */}
